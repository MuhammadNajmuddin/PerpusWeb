                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="judul" type="text" id="judul" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['judul']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pengarang</label>
                              <div class="col-sm-8">
                                  <input name="pengarang" type="text" id="pengarang" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['pengarang']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="th_terbit" type="text" id="th_terbit" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['th_terbit']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="penerbit" type="text" id="penerbit" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['penerbit']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="jumlah_buku" type="text" id="jumlah_buku" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['jumlah_buku']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="lokasi" type="text" id="lokasi" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['lokasi']; ?>" required />
                              </div>
                          </div>                
                          <div class="form-group">
