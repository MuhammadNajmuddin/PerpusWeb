                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="th_terbit" type="text" id="text" class="form-control" placeholder="Tahun Terbit" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kategori" class="form-control" id="kategori" type="text" placeholder="Kategori" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode Kelas</label>
                              <div class="col-sm-8">
                                  <input name="kode_klas" class="form-control" id="kode_klas" type="text" placeholder="Kode Kelas" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="asal" class="form-control" id="asal" type="text" placeholder="Asal" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Tempat</label>
                              <div class="col-sm-8">
                                  <input name="jum_temp" class="form-control" id="jum_temp" type="text" placeholder="Jumlah Temp" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="tambahbuku.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
