...
<head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Perpustakaan Web</title>
...
<?php } ?>
                ...
                <tbody>
                    ...
                    <td><a><span class="fa fa-book"></span> <?php echo $data['judul_buku']; ?></a></td>
              ...
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="transaksi.php" class="btn btn-sm btn-info">Refresh Transaksi <i class="fa fa-refresh"></i></a> <a href="inputtransaksi_pinjam.php" class="btn btn-sm btn-warning">Tambah Transaksi <i class="fa fa-arrow-circle-right"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
